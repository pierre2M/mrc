<script lang="ts">
  ...
  const MODES: {
  ...
  }[] = [
    {
      id: 'decouverte',
      label: 'Découverte',
      desc: 'Questions libres sur le MRC — sans fichier',
      requiresFile: false,
    },
    {
      id: 'analyse',
      label: 'Analyse',
      desc: 'Analyser un document avec le MRC (Couches 0–3)',
      requiresFile: false,
    },
    {
      id: 'expert',
      label: 'Expert',
      desc: 'Analyse complète 9 étapes + vérifiabilité-cohérence',
      requiresFile: false,
      tokenWarning: 'Appel plus long (~15 s) — analyse exhaustive des 9 étapes MRC',
    },
  ];
